...
void loop() {
  ...
  Serial.println("D18 D19 D20 D21 D24 D25 A0   A1   A2   A3   A4   A5   A6   A7   ");
  Serial.printf("%3d %3d %3d %3d %3d %3d %4d %4d %4d %4d %4d %4d %4d %4d %4d\n", digitalRead(18), digitalRead(19), digitalRead(20), digitalRead(21), digitalRead(24), digitalRead(25), analogRead(A0), analogRead(A1), analogRead(A2), analogRead(A3), analogRead(A4), analogRead(A5), analogRead(A6), analogRead(A7));
  delay(200);
